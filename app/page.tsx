      ...
      <main id="top">
        ...
        <div className="wrap">
          <details className="sources">
            <summary>
              <IconChevron />
              Where we look · 22 local sources
              <span className="rule" />
            </summary>
            <div className="source-grid">
              <div className="source-col">
                ...
                {[
                  ...
                  ["Village of Orchard Park", "https://orchardparkvillageny.gov/village-events/"],
                  ["Town of Hamburg", "https://www.townofhamburgny.gov/386/Calendar-of-Events"],
                  ["Village of Hamburg", "https://villageofhamburgny.gov/events"],
                  ["West Seneca", "https://www.westseneca.gov/calendar.aspx"],
                  ["Eden", "https://edenny.gov/news/"],
                  ["Elma", "https://www.elmanewyork.gov/"],
                  ["Boston", "https://www.bostonny.gov/events"],
                  ["Evans", "https://townofevansny.gov/"],
                ].map(([label, href]) => (
              ...
              <div className="source-col">
                <h3>Libraries &amp; community desks</h3>
                {[
                  ["Buffalo & Erie County Public Library", "https://www.buffalolib.org/"],
                  ["EverythingOP", "https://everythingop.com/about-everythingop/"],
                  ["Orchard Park Chamber", "https://orchardparkchamber.org/"],
                  ["Southtowns Regional Chamber", "https://southtownsregionalchamber.org/news-events/"],
                  ["South Buffalo Community Association", "https://www.southbuffalo.org/calendar"],
              ...
              <div className="source-col">
                ...
                {[
                  ...
                  ["West Seneca Bee", "https://westseneca.org/members/west-seneca-bee-2/"],
                  ["The Buffalo News", "https://www.buffalonews.com/"],
