...
const VENUES: Record<string, Coords> = {
  ...
  "angola public library": { lat: 42.6383, lon: -79.0285 },
  "collins public library": { lat: 42.5064, lon: -78.8747 },
  "north collins public library": { lat: 42.5944, lon: -78.9367 },
  "concord public library": { lat: 42.5097, lon: -78.6678 },
  "alden ewell free library": { lat: 42.9014, lon: -78.4933 },
  "clarence public library": { lat: 43.0031, lon: -78.5969 },
  "williamsville library": { lat: 42.9633, lon: -78.7372 },
  "audubon library": { lat: 42.9931, lon: -78.7686 },
  "clearfield library": { lat: 42.9906, lon: -78.8203 },
  "eggertsville-snyder library": { lat: 42.9583, lon: -78.8081 },
  "kenmore library": { lat: 42.9656, lon: -78.8703 },
  "kenilworth library": { lat: 42.9569, lon: -78.8608 },
  "town of tonawanda library": { lat: 42.9819, lon: -78.8814 },
  "newstead public library": { lat: 43.0178, lon: -78.4961 },

  // Kid staples, so the cards read a real distance rather than a town centroid.
  "penn dixie fossil park": { lat: 42.7739, lon: -78.8306 },
  "woodlawn beach state park": { lat: 42.7889, lon: -78.8489 },
  "tifft nature preserve": { lat: 42.8494, lon: -78.8489 },
  "buffalo & erie county botanical gardens": { lat: 42.8342, lon: -78.8214 },
  "botanical gardens": { lat: 42.8342, lon: -78.8214 },
  "buffalo naval park": { lat: 42.8775, lon: -78.8833 },
  "toy town museum": { lat: 42.7658, lon: -78.6208 },
  "vidler s 5 & 10": { lat: 42.7678, lon: -78.6134 },
  "emery park": { lat: 42.7167, lon: -78.5619 },
  "sprague brook park": { lat: 42.6042, lon: -78.6383 },
  "como lake park": { lat: 42.8944, lon: -78.6614 },
  "great pumpkin farm": { lat: 42.9767, lon: -78.5928 },
  "awald farms": { lat: 42.5892, lon: -78.9631 },
  "kelly s country store": { lat: 42.6567, lon: -78.9006 },
  "thorpe s organic family farm": { lat: 42.7169, lon: -78.5511 },
  "mayer brothers cider mill": { lat: 42.8306, lon: -78.7583 },
